...
<template>
	<q-btn label="Feedback" @click="showFeedbackDialog = true" outline/>
			...
			<q-card-section>
				<div>
					...
					<ul>
						...
						<li>
							Join our
							<a href="https://join.slack.com/t/internethealthreport/shared_invite/zt-19d4e48py-~oirVwkINe01gTVEF3o4Kw">Slack workspace</a>
